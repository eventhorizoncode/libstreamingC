 ...
 */
    abstract public class AbstractPacketizer
    {
        ...
        protected const int rtphl = RtpSocket.RTP_HEADER_LENGTH;

        // Maximum size of RTP packets
        protected const int MAXPACKETSIZE = RtpSocket.MTU - 28;

        protected RtpSocket socket = null;
        protected Java.IO.InputStream inputStream = null;
        protected System.IO.Stream inputSStream = null;
        ...
        {
            int ssrc = new Java.Util.Random().NextInt();
            ts = new Java.Util.Random().NextInt();
        ...
        public void setInputSStream(System.IO.Stream inStream)
        {
            this.inputSStream = inStream;
        }
        ...
        protected static System.String printBuffer(byte[] buffer, int start, int end)
        {
            System.String str = "";
        ...
        protected class Statistics
        {
            ...
            public const System.String TAG = "Statistics";
