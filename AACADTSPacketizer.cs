...
namespace Net.Majorkernelpanic.Streaming
{
    ...
    public class AACADTSPacketizer : AbstractPacketizer, IRunnable
    {


        private const System.String TAG = "AACADTSPacketizer";
        ...
        public void Run()
        {
            ...
            Log.Debug(TAG, "AAC ADTS packetizer started !");
            ...
            try
            {
                while (!Thread.Interrupted())
                {
                    ...
                    // Read CRS if any
                    if (!protection) inputStream.Read(header, 0, 2);
            ...
            {
                Log.e(TAG, "ArrayIndexOutOfBoundsException: " + (e.Message != null ? e.Message : "unknown error"));
                e.PrintStackTrace();
            }
